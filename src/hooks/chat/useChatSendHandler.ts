...
import { chatCancelApi, chatSimpleApi, chatStreamApi } from '@/api/chat/chat';
...
export const useChatSendHandler = (chatId: string) => {
  ...
  const [abortData] = useAtom(abortDataAtom);
  ...
  // TODO: progress/citation/cancelled 메시지 처리 (API 연동 시 활성화)
  // const setThoughtData = (dataJson: IMessageResponse) => { ... };
  // const setCitationData = (citation: unknown) => { ... };
